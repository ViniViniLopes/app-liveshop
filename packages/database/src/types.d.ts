...
export type TenantMemberRole = 'owner' | 'admin' | 'seller' | 'live_host' | 'affiliate' | 'affiliate_manager' | 'finance' | 'viewer' | 'support';
...
export type SocialPlatform = 'youtube' | 'meta' | 'facebook' | 'instagram' | 'tiktok' | 'pinterest' | 'linkedin' | 'x';
...
export interface Database {
    public: {
        Tables: {
            ...
            tenant_members: {
                Row: TenantMember;
                Insert: Partial<TenantMember>;
                Update: Partial<TenantMember>;
            };
            tenant_domains: {
                Row: TenantDomain;
                Insert: Partial<TenantDomain>;
                Update: Partial<TenantDomain>;
            };
            tenant_branding: {
                Row: TenantBranding;
                Insert: Partial<TenantBranding>;
                Update: Partial<TenantBranding>;
            };
            platform_admin_users: {
                Row: PlatformAdminUser;
                Insert: Partial<PlatformAdminUser>;
                Update: Partial<PlatformAdminUser>;
            };
            products: {
                Row: Product;
            ...
            affiliate_links: {
                Row: AffiliateLink;
                Insert: Partial<AffiliateLink>;
                Update: Partial<AffiliateLink>;
            };
            affiliate_clicks: {
                Row: AffiliateClick;
                Insert: Partial<AffiliateClick>;
                Update: Partial<AffiliateClick>;
            };
            sales_orders: {
                Row: SalesOrder;
                Insert: Partial<SalesOrder>;
            ...
            notification_jobs: {
                Row: NotificationJob;
                Insert: Partial<NotificationJob>;
                Update: Partial<NotificationJob>;
            };
            audit_logs: {
                Row: AuditLog;
            ...
            tenant_subscriptions: {
                ...
                Insert: Partial<TenantSubscription>;
            ...
            tenant_feature_flags: {
                ...
                Insert: Partial<TenantFeatureFlag>;
                Update: Partial<TenantFeatureFlag>;
            };
            storefront_templates: {
                Row: StorefrontTemplate;
                Insert: Partial<StorefrontTemplate>;
                Update: Partial<StorefrontTemplate>;
            };
            integration_health: {
                Row: IntegrationHealth;
                Insert: Partial<IntegrationHealth>;
                Update: Partial<IntegrationHealth>;
            };
            social_accounts: {
                Row: SocialAccount;
            ...
            social_account_capabilities: {
                Row: SocialAccountCapabilities;
                Insert: Partial<SocialAccountCapabilities>;
                Update: Partial<SocialAccountCapabilities>;
            };
            cloudflare_zones: {
                Row: CloudflareZone;
                Insert: Partial<CloudflareZone>;
                Update: Partial<CloudflareZone>;
            };
        };
        Functions: {
            is_platform_admin: {
